            ...
            Container(
              child: Column(
                children: <Widget>[
                  ...
                  /*Developer DETAILS - CONTACT INFO*/ Padding(
...
//                        hintStyle: TextStyle(color: Colors.grey[800]),
                  ...
                  /*Developer DETAILS - SOCIAL DETAILS*/ Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Container(
                      decoration: BoxDecoration(
                        border: Border.all(
...
//                        hintStyle: TextStyle(color: Colors.grey[800]),
                  ...
                  /*Developer Area/Categories*/ Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Container(
                      decoration: BoxDecoration(
                        border: Border.all(
                    ...
                    child: InkWell(
                      onTap: () {
                        setState(() {
                          showSpinner = true;
                          editProfile(context,
                              'https://americanhomesonline.com/wp-json/api/v1/Edit_Profile/?secret_key=yQTTspWXd530xNAEnBKkMFNFuBbKG6kd');
                        });
                      },
                      child: Container(
                        alignment: Alignment.center,
